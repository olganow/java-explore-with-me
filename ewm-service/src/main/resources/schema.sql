...
initiator_id INT         NOT NULLREFERENCES users (id) ON DELETE CASCADE,
state varchar(256)                             NOT NULL DEFAULT 'PENDING',
created_on TIMESTAMP                           WITHOUT TIME ZONE NOT NULL,
published_on TIMESTAMP                                  WITHOUT TIME ZONE
);

REATE TABLE IF NOT EXISTS compilations (
id INT      GENERATEDBY DEFAULT AS IDENTITY NOT NULL PRIMARY KEY,
